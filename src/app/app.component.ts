...
export class AppComponent {
    public line_ChartData = [
        ['Year', 'Sales', 'Expenses', 'cost', 'value'],
        ['2004', 1000, 400, 745, 179],
        ['2005', 1170, 460, 546, 469],
        ['2006', 660, 1120, 489, 785],
        ['2007', 1030, 540, 946, 983]];
    ...
    public bar_ChartData = [
        ...
        ['Houston, TX', 2099000, 1953000, 'silver'],
        ['Philadelphia, PA', 1526000, 1517000, 'red']];
    ...
    public candle_ChartOptions = {
        ...
        candlestick: {
            fallingColor: {strokeWidth: 0, fill: '#f2ea0c'}, 
            risingColor: {strokeWidth: 0, fill: '#d11cdb'}   
        }
    };
